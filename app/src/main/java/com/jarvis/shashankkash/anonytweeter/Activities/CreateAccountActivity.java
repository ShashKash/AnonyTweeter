...
public class CreateAccountActivity extends AppCompatActivity {
    ...
    private final static int GALLER_INTENT = 3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFirebaseStorage = FirebaseStorage.getInstance().getReference().child("MUser_profilepics");
                    ...
                    .addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                        ...
                        public void onSuccess(AuthResult authResult) {
                            if(authResult != null) {
                                ...
                                StorageReference imagePath = mFirebaseStorage.child("MUser_profilepics").child(resultUri.getLastPathSegment());
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==GALLER_INTENT && resultCode == RESULT_OK) {
